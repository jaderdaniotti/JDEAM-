    ...
    <div class="container-fluid">
        ...
        <div class="row align-content-center d-flex">
            ...
            <div class="col-12 col-md-8 aside-right">
                ...
                <hr>
                <form action="{{route('games.store')}}" method="POST" class="gestione-form" enctype="multipart/form-data" >
                    @csrf
                    <div class="row">
                        <div class="col-8">
                            ...
                            <input type="number" name="year" class="form-control" placeholder="Inserisci il nome della categoria...">
    
                            <label for="name" >Prezzo</label>
                            <input type="number" name="price" class="form-control" placeholder="Inserisci il nome della categoria...">
    
                            <label for="name" >Copertina</label>
                            <input type="file" name="image" class="form-control" placeholder="Inserisci il nome della categoria...">
                        </div>

                        <div class="col-4">
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                  <button class=" collapsed btn" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseCategory" aria-expanded="false" aria-controls="flush-collapseOne">
                                    Categorie
                                  </button>
                                </h2>
                              ...
                              <div class="accordion-item">
                                <h2 class="accordion-header">
                                  <button class="btn collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsePlatform" aria-expanded="false" aria-controls="flush-collapseOne">
                                    Piattaforma
                                  </button>
                                </h2>
                              ...
                              <div class="accordion-item">
                                <h2 class="accordion-header">
                                  <button class="btn collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsePlayer" aria-expanded="false" aria-controls="flush-collapseOne">
                                    Player
                                  </button>
                                </h2>
